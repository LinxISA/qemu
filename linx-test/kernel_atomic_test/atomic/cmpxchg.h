...
#define RISCV_ACQUIRE_BARRIER	ASM_RELEASE_BARRIER_BLOCK(789)
#define RISCV_RELEASE_BARRIER	ASM_ACQUIRE_BARRIER_BLOCK(123)
 ...
 * @order:
 *     optional block atomic.order attribute, e.g. .aqrl
 * @ret, @new, @ptr:
 ...
 *     optional memory fence block, define with ASM_FENCE_BLOCK
 * @order:
 *     optional sc block atomic.order attribute, e.g. .rl
 * @ret, @new, @old, @ptr:
