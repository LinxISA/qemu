...
void set_exception_vector_LEVEL_3_Q_0()
{
    ...
    tne0 = (unsigned long)page_table_1>>12<<32 | PTE_V | PTE_RWXP_NEXT_PTE;
    tne1 = (unsigned long)page_table_2>>12<<32 | PTE_V | PTE_RWXP_NEXT_PTE;
    tne2 = 0x8000100000000 | PTE_RWXP_READ_WRITE_EXEC | PTE_V;
    PT_FILL_LEVEL_3(0x02, tne0, 0x00, tne1, 0x01, tne2)

    tne0 = (unsigned long)page_table_1>>12<<32 | PTE_V | PTE_RWXP_NEXT_PTE;
    tne1 = (unsigned long)page_table_2>>12<<32 | PTE_V | PTE_RWXP_NEXT_PTE;
    tne2 = 0x1000000000000 | PTE_RWXP_READ_WRITE_EXEC | PTE_V;
    PT_FILL_LEVEL_3(0x00, tne0, 0x80, tne1, 0x00, tne2)

    /* set  SP PA:0x800ffxxx == VA:0x800ffxxx */
    tne0 = (unsigned long)page_table_1>>12<<32 | PTE_V | PTE_RWXP_NEXT_PTE;
    tne1 = (unsigned long)page_table_2>>12<<32 | PTE_V | PTE_RWXP_NEXT_PTE;
    tne2 = 0x800ff00000000 | PTE_RWXP_READ_WRITE_EXEC | PTE_V;
    PT_FILL_LEVEL_3(0x02, tne0, 0x00, tne1, 0xff, tne2)

    /* while fetch instruction, let instruction PA: 0x80000xxx == VA:0x80000xxx */
    tne0 = (unsigned long)page_table_1>>12<<32 | PTE_V | PTE_RWXP_NEXT_PTE | PTE_V;
    tne1 = (unsigned long)page_table_2>>12<<32 | PTE_V | PTE_RWXP_NEXT_PTE | PTE_V;
    tne2 = 0x8000000000000 | PTE_RWXP_READ_WRITE_EXEC | PTE_V;
...
int main()
{
    tlb_fill_LEVEL_3_Q_0();
    set_exception_vector_LEVEL_3_Q_0();
