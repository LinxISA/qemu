...
void tlb_fill_LEVEL_3_Q_0_super()
{
    ...
    tne1 =  (((unsigned long)page_table_data >> 20 << 40) | PTE_V | PTE_RWXP_READ_WRITE| 0);
    PT_FILL_LEVEL_3(0x01, tne0, 0x01, tne1, 0x04, 0x00);

    tne0 = (((unsigned long)page_table_1 >> 12 << 32) | PTE_V | PTE_RWXP_NEXT_PTE | 0);
    tne1 =  (((unsigned long)page_table_data >> 20 << 20) | PTE_V | PTE_RWXP_READ_WRITE| 0);
    PT_FILL_LEVEL_3(0x04, tne0, 0x02, tne1, 0x04, 0x00);
