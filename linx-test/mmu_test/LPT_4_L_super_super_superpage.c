...
void test_start_Q_0_super()
{
    ...
    unsigned long long addr = 0x8080004001;
...
void set_pri_to_N_with_enable_mmu_Q_0_super3(int priv)
{
...
void set_exception_vector_LEVEL_4_Q_0_super3()
{
...
void tlb_fill_LEVEL_4_Q_0_super3()
{
    unsigned long tne0 = 0;
    unsigned long tne1 = 0;
    unsigned long tne2 = 0;
    ...
    PT_FILL_LEVEL_4(0x01, tne0, 0x02, 0x00, 0x00, 0x00, 0x04, 0x00);
}

int main()
{
    tlb_fill_LEVEL_4_Q_0_super3();
    set_exception_vector_LEVEL_4_Q_0_super3();
    set_pri_to_N_with_enable_mmu_Q_0_super3(1);
    return 0;
}