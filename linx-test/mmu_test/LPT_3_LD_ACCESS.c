...
void set_exception_vector_LEVEL_3_Q_0_LD()
{
    ...
    tne2 = 0x8000100000000 | PTE_RWXP_EXEC | PTE_V | 0;
    PT_FILL_LEVEL_3(0x02, tne0, 0x00, tne1, 0x01, tne2)

    tne0 = (unsigned long)page_table_1>>12<<32 | 0 | PTE_RWXP_NEXT_PTE | PTE_V;
    tne1 = (unsigned long)page_table_2>>12<<32 | 0 | PTE_RWXP_NEXT_PTE | PTE_V;
    tne2 = 0x800200000000 | PTE_RWXP_EXEC | PTE_V | 0;
...
void tlb_fill_LEVEL_3_Q_0_LD()
{
    ...
    tne2 =  (((unsigned long)page_table_data >> 12 << 32) | PTE_V | PTE_RWXP_EXEC| 0);
...
int main()
{
    tlb_fill_LEVEL_3_Q_0_LD();
    set_exception_vector_LEVEL_3_Q_0_LD();
