...
extern unsigned long page_table_0[0x100];
extern unsigned long page_table_1[0x100];
extern unsigned long page_table_2[0x100];
extern unsigned long page_table_3[0x100];
extern unsigned long page_table_4[0x100];
extern unsigned long page_table_5[0x100];
extern unsigned long page_table_data[0x100];

void set_exception_vector_3_Q_0_st_fault()
{
    ...
    tne2 = 0x8000100000000 | PTE_RWXP_READ_EXEC | PTE_V | 0;
    PT_FILL_LEVEL_3(0x02, tne0, 0x00, tne1, 0x01, tne2)

    tne0 = (unsigned long)page_table_1>>12<<32 | 0 | PTE_RWXP_NEXT_PTE | PTE_V;
    tne1 = (unsigned long)page_table_2>>12<<32 | 0 | PTE_RWXP_NEXT_PTE | PTE_V;
    tne2 = 0x800200000000 | PTE_RWXP_READ_EXEC | PTE_V | 0;
    ...
    tne0 = (unsigned long)page_table_1>>12<<32 | 0 | PTE_RWXP_NEXT_PTE | PTE_V;
    tne1 = (unsigned long)page_table_2>>12<<32 | 0 | PTE_RWXP_NEXT_PTE | PTE_V;
    tne2 = 0x8000000000000 | PTE_RWXP_READ_EXEC | PTE_V | 0;
    ...
    tne2 = (unsigned long)trap_handler>>12<<32 | PTE_RWXP_READ_EXEC | PTE_V | 0;
...
int main()
{
    ...
    tne2 =  (((unsigned long)page_table_data >> 12 << 32) | PTE_V | PTE_RWXP_READ);
    ...
    set_exception_vector_3_Q_0_st_fault();
