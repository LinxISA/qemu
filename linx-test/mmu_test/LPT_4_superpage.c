...
void set_exception_vector_LEVEL_4_Q_0_super()
{
...
void tlb_fill_LEVEL_4_Q_0_super()
{
    unsigned long tne0 = 0;
    unsigned long tne1 = 0;
    unsigned long tne2 = 0;
    ...
    PT_FILL_LEVEL_4(0x00, tne0, 0x01, tne1, 0x01, tne2, 0x04, 0x00);

    tne0 = (((unsigned long)page_table_1 >> 12 << 32) | PTE_V | PTE_RWXP_NEXT_PTE | 0);
    tne1 = (((unsigned long)page_table_2 >> 12 << 32) | PTE_V | PTE_RWXP_NEXT_PTE | 0);
    tne2 =  (((unsigned long)page_table_data >> 20 << 40) | PTE_V | PTE_RWXP_READ_WRITE| 0);
    PT_FILL_LEVEL_4(0x00, tne0, 0x04, tne1, 0x02, tne2, 0x04, 0x00);
}

int main()
{
    tlb_fill_LEVEL_4_Q_0_super();
    set_exception_vector_LEVEL_4_Q_0_super();
