...
static abi_ulong get_sigframe(struct target_sigaction *ka,
                              CPULINXState *regs, size_t framesize)
{
...
static void setup_sigcontext(struct target_sigcontext *sc, CPULINXState *env)
{
    int i;
...
static void setup_ucontext(struct target_ucontext *uc,
                           CPULINXState *env, target_sigset_t *set)
{
...
void setup_rt_frame(int sig, struct target_sigaction *ka,
                    ...
                    target_sigset_t *set, CPULINXState *env)
{
    ...
    /*
     * for jump due to signal's handler,
     * we consider block is end, and reset bstate
     */
...
static void restore_sigcontext(CPULINXState *env, struct target_sigcontext *sc)
{
    int i;
...
static void restore_ucontext(CPULINXState *env, struct target_ucontext *uc)
{
    sigset_t blocked;
...
long do_rt_sigreturn(CPULINXState *env)
{
    struct target_rt_sigframe *frame;
    abi_ulong frame_addr;
