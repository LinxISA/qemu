 ...
 */
#ifndef LINUX_USER_LINX_SYSCALL32_NR_H
#define LINUX_USER_LINX_SYSCALL32_NR_H
...
#define TARGET_NR_linx_flush_icache (TARGET_NR_arch_specific_syscall + 15)
...
#endif /* LINUX_USER_LINX_SYSCALL32_NR_H */
